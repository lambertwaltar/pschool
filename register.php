<?php 
	...
	try {
		...
		$data = array('email' => $email , 'fullnames' => $fullnames, 'password' => $hash, 'salt' => $salt, 'role' => $role, 'phone' => $phone);	
		$query="INSERT INTO account_users (email, name, password, salt, role, phone) VALUES (:email, :fullnames, :password, :salt, :role, :phone)";
