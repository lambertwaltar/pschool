...
<div>
<form action="viewstudents.php" class="form-horizontal form-validate" method="post">
<div class="row">
	<div class="form-group" style="width:900px;">
					<div class="email controls">
						<!--<input type="text" name='sname' placeholder="Student Name" class='form-control' data-rule-required="true" style="width:300px; float:left;">-->
			...
			?>
						...
						<input type="submit" class='btn btn-primary' value="Search" name="submit" style="margin-left:10px; height:34px; margin-top:0px;">
							...
							<div class="box-content nopadding">
								<ul class="tabs tabs-inline tabs-top">
                                     ...
                                     <li>
										...
										<i class="fa fa-user"></i>Student Results</a>
									 </li>
		...
		<div class="box box-bordered">
			...
			<div class="box-content nopadding" style="border-top:solid 2px #09C;">
				...
				<table class="table table-hover table-nomargin table-bordered dataTable dataTable-tools">
					<thead>
					<tr>
						<!--<th class='hidden-350'>File</th>-->
						<th class='hidden-1024'>Description</th>
                        <th class='hidden-1024'>Submit Date</th>
			...
			if(isset($_POST['submit'])){
				...
				?>
					<tr style="text-align:left;background-color:#D2F8FB; margin-top:3px;">
						...
						<td><a href="<?php echo $results['path']; ?>" class="btn btn-default btn-sm" style=" width:200px; background:#75B9C8" ><img src="img/download.png" style=" width:30px; height:30px; margin-right:20px;"> Download</a></td>							
					</tr>
			...
			<!--	<iframe src="uploads/Book1.xlsx" width="100%" height="500"></iframe>-->
